"""
Django settings for luunaproducts project.
...
INSTALLED_APPS = [
    ...
    'apicatalog.apps.ApicatalogConfig',
    'rest_framework',    
    'drf_yasg',
    'django_filters',
    'corsheaders'
...
ROOT_URLCONF = 'luunaproducts.urls'
...
WSGI_APPLICATION = 'luunaproducts.wsgi.application'
